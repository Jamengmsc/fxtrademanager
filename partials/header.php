...
<div class="menu-wrap">
  <div class="menu-list bg-dark">
    ...
    <ul>
      ...
      <li><a href="<?= SITEURL ?>user-profile.php" class="text-uppercase"><div class="icon_cont"><i class="fa fa-user"></i></div>My Profile</a></li>
    </ul>

    <?php
      if($acctID == 546836){
        ?>
          <hr class="bg-warning mx-4 mb-1">
          <a class="text-decoration-none text-light" style="font-size:14px; padding:12px 20px;" href="<?= SITEURL ?>admin/add-pair.php"><div class="icon_cont"><i class="fa fa-user-cog"></i></div> ADMIN PORTAL</a>
        <?php
      }
    ?>
  </div>
